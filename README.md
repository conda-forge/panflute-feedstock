...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/panflute-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/panflute-feedstock)
...
Once the `conda-forge` channel has been enabled, `panflute` can be installed with:

```
conda install panflute
```

It is possible to list all of the versions of `panflute` available on your platform with:
